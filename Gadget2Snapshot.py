...
class Gadget2Snapshot(object):
    ...
    def scatterXYZ(self, fig=None, **kwargs):
        ...
        if not hasattr(self, "types"):
            ...
            ax1.scatter(self.positions[self.types==0,0], self.positions[self.types==0,1], s=1, color='b')
            ax1.scatter(self.positions[self.types==1,0], self.positions[self.types==1,1], s=1, color='k')
            ax1.scatter(self.positions[self.types==2,0], self.positions[self.types==2,1], s=1, color='r')
            ax1.scatter(self.positions[self.types==3,0], self.positions[self.types==3,1], s=1, color='g')
            ax1.scatter(self.positions[self.types==4,0], self.positions[self.types==4,1], s=1, color='y')
        ...
        if not hasattr(self, "types"):
            ...
            ax2.scatter(self.positions[self.types==0,0], self.positions[self.types==0,2], s=1, color='b')
            ax2.scatter(self.positions[self.types==1,0], self.positions[self.types==1,2], s=1, color='k')
            ax2.scatter(self.positions[self.types==2,0], self.positions[self.types==2,2], s=1, color='r')
            ax2.scatter(self.positions[self.types==3,0], self.positions[self.types==3,2], s=1, color='g')
            ax2.scatter(self.positions[self.types==4,0], self.positions[self.types==4,2], s=1, color='y')
        ...
        if not hasattr(self, "types"):
            ...
            ax3.scatter(self.positions[self.types==0,1], self.positions[self.types==0,2], s=1, color='b')
            ax3.scatter(self.positions[self.types==1,1], self.positions[self.types==1,2], s=1, color='k')
            ax3.scatter(self.positions[self.types==2,1], self.positions[self.types==2,2], s=1, color='r')
            ax3.scatter(self.positions[self.types==3,1], self.positions[self.types==3,2], s=1, color='g')
            ax3.scatter(self.positions[self.types==4,1], self.positions[self.types==4,2], s=1, color='y')
